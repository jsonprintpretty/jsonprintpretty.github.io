    String.prototype.replaceAll = function(search, replacement) {
      ...
      function validateJSON() {
        ...
        var inputJSON = document.getElementById("sourcearea").value;
	    ...
	    try {
	     ...
	     document.getElementById("targetarea").value=inputJSON;
	  }
     ...
     function validateXML() {
	    $(oldlineNumber).attr('class', 'lineno');
        var inputXML = document.getElementById("sourcearea").value;
        try {
